       ...
       // SqlConnection connect = new SqlConnection(@"Data Source=ISTIAQ\SQLEXPRESS;Integrated Security=True;Encrypt=False");
        ...
        private void btn_Confirm_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string clearFieldsQuery = "UPDATE admin SET pet = NULL, pet_age = NULL, injection_status = NULL, medicine_needed = NULL, start_date = NULL, checkout_date = NULL, last_payment = 0 WHERE username = @username";
        ...
        private void text_Card_TextChanged(object sender, EventArgs e)
        {
